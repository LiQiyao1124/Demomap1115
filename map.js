...
map.on('mousemove', function(e) {
 ...
 + '</strong>%</em></p>' + '</strong></h3><p><strong>More than $200000: <em>' + blocks[0].properties.F_200_000_ + '</strong>%</em></p>';
    ...
    document.getElementById('info-window-body').innerHTML = '<p>Hover over each block to learn more about income.</p>';
  }
});
...
map.on('mousemove', function(e) {
 ...
 + '</strong>%</em></p>' + '</strong></h3><p><strong>Bachelor degree or higher: <em>' + blocks[0].properties.Bachelor_s + '</strong>%</em></p>';
    ...
    document.getElementById('info-window-body').innerHTML = '<p>Hover over each block to learn more about education.</p>';
  }
});
